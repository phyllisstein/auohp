...
- [Migrate from Gen1](references/guides/migrate-from-gen1.md): Complete step-by-step walkthrough: coexist sp-* and swc-*, swap themes and fonts, map --mod-* overrides to --swc-*, then decommission Gen1.
- [Gen1 vs Gen2](references/guides/gen1-vs-gen2.md): Side-by-side comparison of package names, architecture, styling, and long-term support.
- [Get started (Gen2)](references/guides/get-started.md): Install @adobe/spectrum-wc, add the stylesheet, and use your first swc-* component.
- [Customization: getting started](references/guides/customization-getting-started.md): Required stylesheet setup, PostCSS configuration, and application background color.
- [Customization: theme and scales](references/guides/customization-theme-scales.md): Apply light/dark/adaptive themes and medium/large scale via CSS classes.
- [Customization: fonts](references/guides/customization-fonts.md): Load Adobe Clean Spectrum VF via Adobe Fonts (Typekit), CDN, or self-hosted setup.
- [Customization: component styles](references/guides/customization-component-styles.md): Customise swc-* components via --swc-* CSS custom properties.
- [Support and compatibility (Gen2)](references/guides/support-and-compatibility.md): Browser support, versioning, and semantic versioning policy for @adobe/spectrum-wc.
...
Components with a migration guide: `accordion`, `action-button`, `action-group`, `avatar`, `badge`, `button`, `button-group`, `card`, `close-button`, `color-handle`, `color-loupe`, `divider`, `dropzone`, `illustrated-message`, `infield-button`, `link`, `meter`, `popover`, `progress-bar`, `progress-circle`, `status-light`, `tabs`, `tooltip`, `typography`.
...
- [action-button](references/components/action-button.md)
- [action-group](references/components/action-group.md)
...
- [close-button](references/components/close-button.md)
- [color-handle](references/components/color-handle.md)
- [color-loupe](references/components/color-loupe.md)
- [divider](references/components/divider.md)
- [dropzone](references/components/dropzone.md)
- [illustrated-message](references/components/illustrated-message.md)
- [infield-button](references/components/infield-button.md)
...
- [progress-circle](references/components/progress-circle.md)
- [status-light](references/components/status-light.md)
