...
export type TranscriptQuery = { health: string, interviewTranscript: { uid: string, statements: Array<{ uid: string, startTime: number | null, endTime: number | null, text: string }> } };
