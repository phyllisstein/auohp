...
export type TranscriptQuery = { health: string, interview: { uid: string, interviewee: string }, interviewTranscript: { uid: string, interview: { uid: string }, statements: Array<{ uid: string, startTime: number | null, endTime: number | null, text: string }> } };
...
export type SearchStatementsQuery = { searchStatements: Array<{ statement: { uid: string, text: string } }> };
