...
export type TranscriptQuery = { interview: TranscriptQuery_interview };
...
export type EditStatementMutation_editStatement = { oldHash: string; newHash: string; statement: EditStatementMutation_editStatement_statement };
